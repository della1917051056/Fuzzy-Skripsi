                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <?php if ($i == $j) : ?>
                            <?php $cek = true; ?>
                            <td><input type="number" name="<?= $i . '_' . $j; ?>" min=0 step="0.01" max=9
                                    style="width:35px;" readonly value="1" id="<?= $i . '_' . $j; ?>" require /></td>
                            <?php continue; ?>
                            <?php endif; ?>
                            <td><input type="text" name="<?= $i . '_' . $j; ?>" min=0 step="0.01" max=9
                                    style="width:35px;" readonly id="<?= $i . '_' . $j; ?>" require /></td>
                            <?php else : ?>
                            <td><input type="number" name="<?= $i . '_' . $j; ?>" min=0 step="0.01" max=9
                                    style="width:35px;" id="<?= $i . '_' . $j; ?>" onkeyup="getInverse(this, event)"
                                    require /></td>
                            <?php endif; ?>
                            <?php endfor; ?>
                        </tr>
    ...
    $("#hitungMat").submit(function(e) {
        ...
        $.ajax({
            ...
            success: function(kriteria) {
                ...
                document.getElementById("hasil_kriteria").value = JSON.stringify(data
                    .kriteria)
            },
